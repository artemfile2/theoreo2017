    ...
    var q, j, r, i = d(window),
        u = {
            ...
            bootstrap: {
                ...
                info: "alert-info",
                info_icon: "fa fa-info-circle fa-lg fa-white",
                success: "alert-success",
                success_icon: "fa fa-check fa-lg fa-white",
                error: "alert-error",
                error_icon: "fa fa-exclamation-triangle fa-lg fa-white",
                closer: "fa fa-close fa-lg fa-red",
                pin_up: "icon-pause",
                pin_down: "icon-play",
                hi_menu: "well",
                hi_btn: "btn",
