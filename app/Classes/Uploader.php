...
class Uploader
{
    ...
    {
        $basePath = !is_null($section) ?  config('site.uploadPath', storage_path()) . '/'. $section : config('site.uploadPath', storage_path()) . '/' . config('site.defaultUploadSection', 'files');
        ...
        if (!File::exists($newPath)) {
            if (!File::makeDirectory($newPath, config('site.storagePermissions', 0755), true)) {
